...
insert into viswk_db.public.newtablesnowewf2
select 1000,'viswajith','India'
union all
select 2000,'visw','uk'
union all
...
insert into viswk_db.public.newtablesnowew
select 1000,'viswajith','India'
union all
select 2000,'visw','uk'
union all
...
insert into viswk_db.public.newtablesf1newnewchanges
select 1000,'viswajith','India'
union all
select 2000,'visw','uk'
union all
...
insert into viswk_db.public.F2newchanges
select 1000,'viswajith','India'
union all
select 2000,'visw','uk'
union all
